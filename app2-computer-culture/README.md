...
- Foo/Bar：占位符名称，用于示例代码或伪代码中。表示「随便什么东西」。比如一个用作例子的Windows平台可执行文件可以命名为`Foo.exe`。
...
- AFK：“Away From Keyboard”（离开键盘），表示聊天中暂时离开。这一俚语并不是严格意义上的计算机俚语，也多见于计算机社区外(如在游戏社区中“挂机”一词也可以称为AFK)。
